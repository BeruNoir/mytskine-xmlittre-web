...
makeFoundation appSettings = do
    ...
    let mkFoundation appConnPool = App {..}
        ...
        appSphinxConfig = appSphinxConf appSettings

    -- Create the database connection pool
    pool <- flip runLoggingT logFunc $ createSqlitePoolConn
...
createSqlitePoolConn :: (MonadIO m, MonadLogger m, MonadBaseControl IO m) => Text -> Int -> m ConnectionPool
createSqlitePoolConn cs =
    createSqlPool (customConn cs)
  where
      customConn :: Text -> LogFunc -> IO SqlBackend
